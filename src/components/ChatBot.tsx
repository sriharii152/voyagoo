            ...
            <div ref={scrollRef} className="flex-1 overflow-y-auto p-4 space-y-3">
              {messages.length === 0 && (
                <div className="text-center text-muted-foreground text-sm mt-8">
                  <Bot className="h-10 w-10 mx-auto mb-3 text-primary opacity-50" />
                  <p className="font-medium">Hi! I'm your travel assistant 🌍</p>
                  <p className="text-xs mt-1">Ask me about adventure activities, local guides, or travel tips!</p>
                </div>
              )}
              {messages.map((msg, i) => (
            ...
            <div className="p-3 border-t border-border">
              ...
              >
                <input
                  ...
                  placeholder="Ask about activities, trips..."
                  className="flex-1 rounded-xl border border-input bg-background px-3 py-2 text-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                  disabled={isLoading}
                />
                <Button
                  type="submit"
