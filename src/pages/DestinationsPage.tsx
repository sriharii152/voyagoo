...
const allDestinations: Destination[] = [
  { name: "Santorini", country: "Greece", image: destSantorini, rating: 4.9, tag: "Romantic", category: "international", description: "White-washed buildings perched on volcanic cliffs with stunning sunset views over the Aegean Sea.", budget: "$150-300/day", bestTime: "Apr-Oct" },
  { name: "Kyoto", country: "Japan", image: destKyoto, rating: 4.8, tag: "Cultural", category: "international", description: "Ancient temples, zen gardens, and traditional geisha districts amidst cherry blossoms.", budget: "$100-200/day", bestTime: "Mar-May, Oct-Nov" },
  { name: "Machu Picchu", country: "Peru", image: destMachuPicchu, rating: 4.9, tag: "Adventure", category: "international", description: "Mysterious Incan citadel set high in the Andes Mountains, a wonder of the world.", budget: "$80-150/day", bestTime: "May-Sep" },
  { name: "Bali", country: "Indonesia", image: destBali, rating: 4.7, tag: "Tropical", category: "international", description: "Lush rice terraces, sacred temples, vibrant culture, and world-class surfing.", budget: "$40-100/day", bestTime: "Apr-Oct" },
  { name: "Paris", country: "France", image: destSantorini, rating: 4.8, tag: "Romantic", category: "international", description: "The City of Light — iconic landmarks, world-class cuisine, and unmatched art.", budget: "$150-350/day", bestTime: "Apr-Jun, Sep-Oct" },
  { name: "Dubai", country: "UAE", image: destKyoto, rating: 4.6, tag: "Luxury", category: "international", description: "Futuristic skyline, luxury shopping, desert safaris, and golden beaches.", budget: "$150-400/day", bestTime: "Nov-Mar" },
  { name: "Jaipur", country: "Rajasthan", image: destSantorini, rating: 4.6, tag: "Heritage", category: "national", description: "The Pink City — majestic forts, colorful bazaars, and royal Rajasthani culture.", budget: "$30-80/day", bestTime: "Oct-Mar" },
  { name: "Kerala", country: "God's Own Country", image: destBali, rating: 4.8, tag: "Nature", category: "national", description: "Serene backwaters, lush tea plantations, Ayurvedic retreats, and tropical beaches.", budget: "$25-70/day", bestTime: "Sep-Mar" },
  { name: "Varanasi", country: "Uttar Pradesh", image: destKyoto, rating: 4.5, tag: "Spiritual", category: "national", description: "One of the world's oldest cities — sacred ghats, evening aarti, and spiritual awakening.", budget: "$15-40/day", bestTime: "Oct-Mar" },
  { name: "Ladakh", country: "Jammu & Kashmir", image: destMachuPicchu, rating: 4.9, tag: "Adventure", category: "national", description: "High-altitude desert with stunning monasteries, pristine lakes, and thrilling passes.", budget: "$40-100/day", bestTime: "Jun-Sep" },
  { name: "Goa", country: "India", image: destBali, rating: 4.5, tag: "Beach", category: "national", description: "Sun-kissed beaches, vibrant nightlife, Portuguese architecture, and seafood paradise.", budget: "$20-60/day", bestTime: "Nov-Feb" },
  { name: "Manali", country: "Himachal Pradesh", image: destMachuPicchu, rating: 4.6, tag: "Mountains", category: "national", description: "Snow-capped peaks, river rafting, paragliding, and cozy mountain cafés.", budget: "$20-50/day", bestTime: "Oct-Jun" },
  { name: "Munnar", country: "Kerala", image: destBali, rating: 4.7, tag: "Hill Station", category: "state", description: "Endless rolling tea gardens, misty mountains, and exotic wildlife sanctuaries.", budget: "$20-50/day", bestTime: "Sep-May" },
  { name: "Coorg", country: "Karnataka", image: destKyoto, rating: 4.6, tag: "Coffee Country", category: "state", description: "Lush coffee plantations, waterfalls, and trekking trails in the Western Ghats.", budget: "$25-60/day", bestTime: "Oct-Mar" },
  { name: "Ooty", country: "Tamil Nadu", image: destMachuPicchu, rating: 4.5, tag: "Scenic", category: "state", description: "The Queen of Hill Stations — botanical gardens, toy train, and eucalyptus forests.", budget: "$20-50/day", bestTime: "Oct-Jun" },
  { name: "Lonavala", country: "Maharashtra", image: destSantorini, rating: 4.4, tag: "Weekend Getaway", category: "state", description: "Misty hills, ancient caves, serene lakes, and the famous chikki sweets.", budget: "$15-40/day", bestTime: "Jun-Sep" },
];
